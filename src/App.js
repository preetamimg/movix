  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path='/movie' exact element={<ExploreMovie/>}/>
        <Route path='/tv' exact element={<ExploreTv/>}/>
        <Route path='/privacy-policy' exact element={<PrivacyPolicy/>}/>
        <Route path='/terms-of-use' exact element={<TermsOfUse/>}/>
        <Route path='/about-us' exact element={<AboutUs a={a}/>}/>
        <Route path='/geners/:genreName' element={<ExploreGeneres/>}/>
